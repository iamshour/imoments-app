		...
		<div className='about-page'>
			<div className='container'>
				...
				<div className='question'>
					<h1>Features</h1>
					<p>
						First of all, Users are able to register using their Google account or through
				...
				<div className='question'>
					<h1>About me</h1>
					<p>
						My name is Ali Shour, a web developer with UI desgin experience as well,
						currently working as a freelnacer. My focus is to help small businesses and
						start ups in enhancing their online presence with modern animated websites,
						landing pages, or bigger projects such e-commerce wqebapps. Read more about me
						and check out my latest projects by visiting my website below, or reach me out
						on my social media!
					</p>
				</div>
